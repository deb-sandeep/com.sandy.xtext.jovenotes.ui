		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getChapterDetailsAccess().getExerciseBankAssignment_1(), "rule__ChapterDetails__ExerciseBankAssignment_1");
					put(grammarAccess.getChapterDetailsAccess().getSubjectNameAssignment_3(), "rule__ChapterDetails__SubjectNameAssignment_3");
					put(grammarAccess.getChapterDetailsAccess().getChapterNumberAssignment_5(), "rule__ChapterDetails__ChapterNumberAssignment_5");
					put(grammarAccess.getChapterDetailsAccess().getSubChapterNumberAssignment_7(), "rule__ChapterDetails__SubChapterNumberAssignment_7");
					put(grammarAccess.getChapterDetailsAccess().getChapterNameAssignment_9(), "rule__ChapterDetails__ChapterNameAssignment_9");
					put(grammarAccess.getChapterDetailsAccess().getScriptBodyAssignment_10(), "rule__ChapterDetails__ScriptBodyAssignment_10");
